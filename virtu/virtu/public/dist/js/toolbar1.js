...
lib.ssMetadata = [
		...
		{name:"toolbar_atlas_2", frames: [[297,1362,225,315],[724,1626,295,21],[524,1362,214,221],[0,1549,94,101],[138,1381,133,165],[1002,0,13,22],[297,1002,535,179],[297,1183,533,177],[524,1626,198,56],[0,1002,295,377],[524,1585,316,39],[740,1362,88,79],[740,1443,58,39],[138,1548,99,136],[0,0,1000,1000],[834,1002,146,314],[0,1381,136,166],[982,1002,32,32],[832,1318,174,246]]}
];
...
(lib.toolbar = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function dropdom()
		{
			if(root.beaker2.x>394 && root.beaker2.x<796 && root.beaker2.y>389.95 && root.beaker2.y<537.9)
			{
				...
				if(s==10)
				{
					var v=(Math.floor(Math.random() * (2.5 - 1.2 + 1)) + 1.2).toFixed(1);
					document.getElementById('label').innerHTML=v;
				}
				else if(s==20)
				{
					var v=(Math.floor(Math.random() * (4.5 - 2.5 + 1)) + 2.5).toFixed(1);
					document.getElementById('label').innerHTML=v;
				}
				else if(s==30)
				{
					var v=(Math.floor(Math.random() * (7.5 - 4.5 + 1)) + 4.5).toFixed(1);
					document.getElementById('label').innerHTML=v;
				}
				else if(s==40)
				{
					var v=(Math.floor(Math.random() * (9.5 - 7.5 + 1)) + 7.5).toFixed(1);
					document.getElementById('label').innerHTML=v;
				}
				else if(s==50)
				{
					var v=(Math.floor(Math.random() * (12 - 9.5 + 1)) + 9.5).toFixed(1);
					document.getElementById('label').innerHTML=v;
				}
			}
		}
	...
	this.button.setTransform(706.7,514.65,0.9453,0.9453,0,0,0,74.4,36.6);
	...
	this.instance_5 = new lib.CachedTexturedBitmap_1();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images1/Bitmap11.png?1618311375757", id:"Bitmap11"},
		{src:"images1/burette.png?1618311375757", id:"burette"},
		{src:"images1/toolbar_atlas_.png?1618311374903", id:"toolbar_atlas_"},
		{src:"images1/toolbar_atlas_2.png?1618311374905", id:"toolbar_atlas_2"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1618311375757", id:"lib/jquery-2.2.4.min.js"},
		{src:"components1/sdk/anwidget.js?1618311375757", id:"sdk/anwidget.js"},
		{src:"components1/ui/src/label.js?1618311375757", id:"an.Label"}
	],
	preloads: []
};
