  ...
  <head>
    ...
    $(document).ready(function(){
        $(".add-row").click(function(){
            ...
            var pswd = $("#pswd").val();
            var cpswd = $("#cpswd").val();
            var markup = "<tr><td><input type='checkbox' name='record'></td><td>" + name + "</td><td>" + email + "</td></td>"+ "</td><td>" + pswd + "</td></td>"+ "</td><td>" + cpswd + "</td></tr>";
...
.step.finish {
  ...
  <div><img src="{{asset('assets/images/main_banner.png')}}" alt="Avatar"></div>
    ...
    {{csrf_field()}}
   <div class="tab">
  <h1> Welcome to Chemistry Virtual lab</h1>
   <p id="s"style="margin-left: 195px;">Determination of Equivalent Conductance of Strong Electrolyte at Infinite Dilution</p>
...
src="https://drive.google.com/file/d/18GrZ1thbiaEJMyzAeZkeITuC8hgffYts/preview">
  ...
  <div class="tab">
    <div>
  <h1>Virtual lab</h1>
    <iframe src="{{url('sample1')}}" width="810" height="610" style="background-color:white"></iframe>
    </div>
    <div>
<input type="text" id="name" placeholder="Concentration of the strong electrolyte N">
<input type="text" id="email" placeholder="C1/2(equiv/L)1/2">
<input type="text" id="pswd" placeholder="Specific Conductance">
<input type="text" id="cpswd" placeholder="^equiv=1000k/c">
<input type="button" class="add-row" value="Add Row"></br></br>
    ...
    <table id="table1">
        <thead>
            <tr>
                <th>Select</th>
                <th>Concentration of the strong electrolyte N</th>
                <th>C1/2(equiv/L)1/2</th>
...
function check()
{
  ...
  function generate() {  
    ...
    doc.text(70, 20, "Strong Electrolyte");  
