...
.step.finish {
  ...
  <h1> Welcome to Virtual Chemistry Laboratory</h1>
   <p id="s"style="margin-left: 195px;">Determination of Strength of Given Solution Using Conductometric Meter</p>
...
src="https://drive.google.com/file/d/18GrZ1thbiaEJMyzAeZkeITuC8hgffYts/preview">
  ...
  <h1>Quiz</h1>
                    ...
                    <input type="hidden" value="exp001" name="experid"/>
  ...
  <div class="tab">
    <div>
  <h1>Virtual lab</h1>
    <iframe src="{{url('sample')}}" width="810" height="610" style="background-color:white"></iframe>
    </div>
    <div>
    ...
    <table id="table1">
        <thead>
            <tr>
                ...
                <th>value of conducto metric</th>
            </tr>
        </thead>
        <tbody>
