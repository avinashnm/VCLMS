...
<script src="{{asset('dist/js/toolbar1.js')}}"></script>
<script>
...
function init() {
	...
	var comp=AdobeAn.getComposition("76857F72BA2BB14CA406A3895EBC161A");
...
<body onload="init();" style="margin:0px;">
	<div id="animation_container" style="background-color:rgba(204, 204, 204, 1.00); width:800px; height:600px">
		<canvas id="canvas" width="800" height="600" style="position: absolute; display: block; background-color:rgba(204, 204, 204, 1.00);"></canvas>
