  ...
  <div class="main_container">
      <div class="sidebar">
       ...
       <div class="container">
        <div class="item">
        <div clas="row">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#basicExampleModal"><i class="fa fa-plus" aria-hidden="true"></i> Add Student</button>
       ...
       <div class="modal-content" style="width: 602px;">
          ...
          <form method="post" action="{{url('studentregister')}}">
             {{ csrf_field() }}
          <div class="modal-body">
            ...
            <div class="col">
              <input type="text" class="form-control" placeholder="Student Regno" name="regno">
              </div>
              <div class="col">
            ...
            <div class="col">
              <input type="text" class="form-control" placeholder="Student Phoneno" name="phoneno">
              </div>
            </div>

            <div class="row" style="margin-top: 6px;">
              <div class="col">
              <input type="password" class="form-control" placeholder="Student password" name="pswd">
    ...
    <div class="modal-content text-center">
      ...
      <form method="post" action="{{url('studentdelete')}}" id="editForm">
             {{ csrf_field() }}
      <!--Body-->
      <div class="modal-body">
      <input type="hidden" class="form-control" id="regno" placeholder="Student Regno" name="regno" Readonly>
    ...
    <!--/.Content-->
       ...
       <div class="modal-content" style="width: 602px;">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Students update Form</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form method="post" action="{{url('studentupdate')}}">
             {{ csrf_field() }}
          <div class="modal-body">
            ...
            <div class="col">
              <input type="text" class="form-control" placeholder="Student Regno" name="regno" id="regno1"  Readonly>
              </div>
              <div class="col">
           ...
           <div class="col">
              ...
              <div class="row" style="margin-top: 6px;">
              <div class="col">
              <input type="password" class="form-control" placeholder="Student password" name="pswd" id="pswd">
              </div>
            </div>
            <div class="row" style="margin-top: 6px;">
            <div class="col">
              <input type="text" class="form-control" placeholder="Student Email" name="email" id="email">
              </div>
            <div class="col">
              <input type="text" class="form-control" placeholder="Student Phoneno" name="phoneno" id="phoneno">
              </div>
            </div>
              <div class="row" style="margin-top: 6px;">
              <div class="col">
