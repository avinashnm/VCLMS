...
<title>RECOVER_Exp1BackUp</title>
<!-- write your code here -->
<script src="{{asset('dist/js/create.js')}}"></script>
<script src="{{asset('dist/js/rastmethod.js')}}"></script>
<script>
...
<body onload="init();" style="margin:0px;">
	<div id="animation_container" style="background-color:rgba(102, 102, 102, 1.00); width:800px; height:600px">
		<canvas id="canvas" width="800" height="600" style="position: absolute; display: block; background-color:rgba(102, 102, 102, 1.00);"></canvas>
