  ...
  <head>
    ...
    $(document).ready(function(){
        $(".add-row").click(function(){
            ...
            var t1 = $("#t1").val();
            var t2 = $("#t2").val();
            var markup = "<tr><td><input type='checkbox' name='record'></td><td>" + name + "</td><td>" + email + "</td><td>" + t1 + "</td><td>" + t2 + "</td></tr>";
...
.step.finish {
  ...
  <h1> Welcome to Chemistry Virtual lab</h1>
   <p id="s"style="margin-left: 195px;">Determination of Molecular Weight of the Solute by Rast Method</p>
...
src="https://drive.google.com/file/d/18GrZ1thbiaEJMyzAeZkeITuC8hgffYts/preview">
  ...
  <div class="tab">
    <div>
  <h1>Virtual lab</h1>
    <iframe src="{{url('sample3')}}" width="810" height="610" style="background-color:white"></iframe>
    </div>
    <div>
...
function check()
{
  ...
  function generate() {  
    ...
    doc.text(70, 20, "Rast Experiment");  
    ...
    doc.text(10,40,"video Score:"+v);
    doc.text(10,50,"Quiz Score:"+c);
